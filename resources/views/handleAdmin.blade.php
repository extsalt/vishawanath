{{-- <form action="https://www.paypal.com/cgi-bin/webscr" method="post" id="myForm">
    <input type="hidden" name="business" value="info@intellippt.com">
    <input type="hidden" name="custom" value="{{ Auth::id() }}">
    <input type="hidden" name="cmd" value="_xclick">
    <input type="hidden" name="item_name" value="Intellippt">
    <input type="hidden" name="item_number" value="1">
    <input type="hidden" name="amount" value="5">
    <input type="hidden" name="currency_code" value="USD">
    <input type="hidden" name="return" value="{{ url('/account') }}">
...
<!---Start Sandbox Account.  This section commented "{{--" "--}}" ---> 
...
@endif
    ...
    <input type="hidden" name="return" value="{{ url('/account') }}">
    <input type="hidden" name="cancel_return" value="{{ url('/cancel') }}">
    <!--<input type="hidden" name="notify_url" value="https://devbranch123.intellippt.com/notify"> -->
