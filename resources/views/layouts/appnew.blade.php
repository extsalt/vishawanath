...
@section('meta_desc')
    <meta name="description" content="Intellippt is an online tool for summarization. An AI summary writer, automatic text summarizer, summary generator, text simplifier that help to summarize articles, text, paragraph, PDF & documents. Register for free and start summarizing." />
@show
<?php
...
<link rel="canonical" href="https://www.intellippt.com<?php echo $canonical ?>" />
	...
	<!-- custom css -->
	<link href="{{ asset('assets/css/styles-2.css') }}" rel="stylesheet" id="colors" async defer media="print" onload="this.media='all'">

	<link href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.2/themes/smoothness/jquery-ui.css" rel="stylesheet" / media="print" onload="this.media='all'">
...
<script async='async' src="https://www.googletagmanager.com/gtag/js?id=UA-92615125-2"></script>
<script async>
...
<noscript><iframe loading="lazy" src="https://www.googletagmanager.com/ns.html?id=GTM-MGC65RB"
...
<div class="alert alert-success alert-dismissible" style="display:none;">
    ...
    <div class="main-wrapper">
        ...
        <footer class="footer-style9 bg-white" style="display:none;">
