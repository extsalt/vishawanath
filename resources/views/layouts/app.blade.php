...
<link rel="canonical" href="https://www.intellippt.com<?php echo $canonical ?>" />
	...
	<link href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/themes/smoothness/jquery-ui.css" rel="stylesheet" / media="print" onload="this.media='all'">
                            ...
                            <div class="menu_area alt-font">
                                <nav class="navbar navbar-expand-lg navbar-light no-padding">
                                    ...
                                    <div class="navbar-header navbar-header-custom">
                                        <!-- start logo -->
                                        <a href="/" class="navbar-brand"><img id="logo" width="100%" height="100%" src="{{ asset('assets/img/logos/intellitppt.png') }}" alt="logo"></a>
                                        <!-- end logo -->
                                    </div>
