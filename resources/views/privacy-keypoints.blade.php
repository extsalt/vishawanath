@extends('layouts.app')
@section('title', 'Privacy Policy - KeyPoints | Intellippt')
@section('meta_desc')
<meta name="description" content="IntelliPPT's Privacy Policy for KeyPoints">
@overwrite
@section('content')
...
<section class="bg-light-gray" style="padding-top: 90px;">
    <div class="container">
        ...
        <div class="section-heading">
            <h1>Privacy Policy for KeyPoints</h1>
        </div>
