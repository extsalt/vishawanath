                    ...
                    <div class="row">
                            ...
                            <div class="card card-white stats-widget">
                                <div class="card-body">
                                    <div class="float-left">
                                        <span class="stats-number">{{ $subscribers }}</span>
                                        <p class="stats-info">Total Subscribers</p>
                                    </div>
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-6">
                            <div class="card card-white stats-widget">
                                <div class="card-body">
                                    <div class="float-left">
                                        <span class="stats-number">{{ $active }} &emsp;&emsp;&emsp;</span>
                                        <p class="stats-info">Active</p>
                                    </div>
                                    <div class="float-right">
                                        <i class="fas fa-tasks stats-icon text-success success"></i>
                                    </div>
                            ...
                            <div class="card card-white stats-widget">
                                <div class="card-body">
                                    <div class="float-left">
                                        ...
                                        <p class="stats-info">Inactive &emsp;</p>
                                    </div>
                                    <div class="float-right">
                                        <i class="fas fa-tasks stats-icon text-success success"></i>
                                    </div>
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-6">
                            <div class="card card-white stats-widget">
                                <div class="card-body">
                                    <div class="float-left">
                                        <span class="stats-number">{{ $cancelled }}</span>
                                        <p class="stats-info">Cancelled </p>
                                    </div>
                                    <div class="float-right">
                                        <i class="fas fa-tasks stats-icon text-success success"></i>
                                    </div>
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-6"></div>
                        <div class="col-xl-2 col-lg-2 col-md-6 pb-4">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-6 pt-4 pb-4">
                            <label>&nbsp; </label>
