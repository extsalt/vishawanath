@extends('layouts.app')
@section('title', 'Privacy Policy - Intellippt')
@section('meta_desc')
<meta name="description" content="IntelliPPT's Privacy Policy">
@overwrite
@section('content')
<!--<title>{{ config('app.name', 'IntelliPPT.com') }} - IntelliPPT's Privacy Policy</title>-->
<!-- start page title section -->
<section class="bg-light-gray" style="padding-top: 90px;">
    <div class="container">

        <div class="section-heading">
            <h1>Privacy Policy for IntelliPPT</h1>
        </div>
        ...
        <div class="row mt-60">
			...
			<h4>Policy</h4>
			<p>Your privacy is important to us. It is Cloudrobo technologies LLP's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, https://www.intellippt.com, and other sites we own and operate.</p>
...
<p>This policy is effective as of 22 February 2021.</p>

<p>Last updated: 22 February 2021 </p>
                    </div>
                </div>
            </div>
...
<p>Data we collect can depend on the individual settings of your device and software. We recommend checking the policies of your device manufacturer or software provider to learn what information they make available to us. </p>
            ...
            <div class="col-lg-12 col-md-12 margin-20px-bottom ">
                <div class="service-block4 h-100">
                    ...
                    <div class="service-desc">
                        <h4>Users request for data/login deletion</h4>
                        <p> Our website doesn't store/save any user data. The only data we save is the user login data, which can be deleted based on the user's request. The user can approach using our contact page https://www.intellippt.com/#contact_us or email us directly at info@intellippt.com . The user data will be deleted in 3-5 business days, after receiving the request.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 margin-20px-bottom ">
            ...
            <div class="col-lg-12 col-md-12 margin-20px-bottom ">
                <div class="service-block4 h-100">
                    ...
                    <div class="service-desc">
                        ...
                        <p>Viswanath Alikonda</p>
                        <p>https://www.intellippt.com <p>
                    </div>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 margin-20px-bottom ">
                <div class="service-block4 h-100">
                    ...
                    <div class="service-desc">
                        <h4>Terms</h4>
                        <p> <a href='/terms' style='color: #0073dc;'>Click Here </a> for Intellippt Terms and Conditions.</p>
                    </div>
                </div>
            </div>
